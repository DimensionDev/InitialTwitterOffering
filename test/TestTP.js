...
contract("HappyTokenPool", accounts => {
    ...
    it("Should allow one to exchange 2 tokenB for 1 token A.", async () => {
        await testtokenB.approve.sendTransaction(accounts[1], 2);
        await testtokenB.transfer.sendTransaction(accounts[1], 2);
    ...
    it("Should allow one to exchange 1 tokenC for 2 token A.", async () => {
        await testtokenC.approve.sendTransaction(accounts[2], 1);
        await testtokenC.transfer.sendTransaction(accounts[2], 1);
