...
const fill_success_encode = 'FillSuccess(uint256,bytes32,address,uint256,address,string,uint256,uint256,address[],uint128[],address,uint256)'
const fill_success_types = [
    ...
    { type: 'address[]', name: 'exchange_addrs' },
